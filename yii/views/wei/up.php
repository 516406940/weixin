        ...
        <div class="graphs">
            <div class="xs">
                ...
                <div class="col-md-8 inbox_right">
                    <form action="index.php?r=wei/up_pro" method="post">
                        <div class="Compose-Message">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <label>公众号 : </label>
                                    <input type="text" class="form-control1 control3" name="a_name" value="<?php echo $arr['a_name']?>">
                                    <label>密码 :  </label>
                                    <input type="password" class="form-control1 control3" name="a_pwd" value="<?php echo $arr['a_pwd']?>">
